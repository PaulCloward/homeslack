...
export class ImageUploadComponent implements OnInit {
  ...
  constructor(private _homeService: HomeService, private router:Router, private storage: AngularFireStorage, private db: AngularFirestore) { 
  }
  ...
  clickNextPage(){
    ...
    this.router.navigate(['/confirm-listing']);
  }  
}
